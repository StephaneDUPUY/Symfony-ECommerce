...
class DefaultController extends Controller
{
    ...
    {
        $wife = 'Emilie';
        $pets = ['coco', 'frimousse', 'waiti', 'nina'];
        return $this->render('EcommerceBundle:Default:index.html.twig', array('firstname' => $firstName, 'lastname' => $lastName, 'wife' => $wife, 'pets' => $pets));
